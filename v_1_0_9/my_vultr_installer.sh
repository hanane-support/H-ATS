...
APP_PORT=8000
# [최종 변경] Supervisor 프로그램 이름을 "server_log"로 지정
SUPERVISOR_PROGRAM_NAME="server_log"
DB_FILE_NAME="admin_config.db"
MY_IP="61.85.61.62"
...
echo ">> UFW 방화벽 설정 (22번 및 80번 포트 허용) 시작..."
...
# H-ATS/v_1_0_5 디렉토리로 이동하여 설치를 진행합니다.
...
echo ">> Caddyfile (${CADDY_CONF}) 생성 및 MY_IP 제한 설정..."
